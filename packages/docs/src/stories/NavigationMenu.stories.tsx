    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <div className="grid gap-3 p-4 w-[600px] grid-cols-[1fr_2fr]">
              <div className="row-span-3 p-4 bg-primary-subtle rounded-lg">
                <div className="font-medium text-lg mb-2">Featured</div>
                <p className="text-sm text-fg-muted mb-4">
                  Check out our latest product with amazing features.
                </p>
                <NavigationMenuLink href="#" className="text-sm text-primary">
                  Learn more →
                </NavigationMenuLink>
              </div>
              <NavigationMenuLink href="#">
      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 w-[500px] grid-cols-2">
              <li>
                <NavigationMenuLink href="#" className="flex items-start gap-3">
